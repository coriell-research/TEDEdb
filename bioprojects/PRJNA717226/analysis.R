...
metadata[
  grepl("Baseline", group),
  group := gsub("Baseline.Untreated", "Untreated", group)
]
metadata[
  grepl("Untreated.Untreated", group),
  group := gsub("Untreated.Untreated", "Untreated", group)
]
...
cm <- makeContrasts(
  COV362_5uM.azacitidine_72hr.20uM.carboplatin_48hr_vs_Untreated = COV362_5µM.azacitidine..20µM.carboplatin -
    COV362_Untreated,
  OAW28_5uM.azacitidine_72hr.20uM.carboplatin_48hr_vs_Untreated = OAW28_5µM.azacitidine..20µM.carboplatin -
    OAW28_Untreated,
  OVCAR4_5uM.azacitidine_72hr.20uM.carboplatin_48hr_vs_Untreated = OVCAR4_5µM.azacitidine..20µM.carboplatin -
    OVCAR4_Untreated,
  TYKnu_5uM.azacitidine_72hr.20uM.carboplatin_48hr_vs_Untreated = TYKnu_5µM.azacitidine..20µM.carboplatin -
    TYKnu_Untreated,
  levels = design
)
