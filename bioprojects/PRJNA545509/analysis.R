...
cm <- makeContrasts(
  ...
  SUM159.JQ1.100nM.paclitaxel.0.6nM_vs_DMSO = SUM159.JQ1.paclitaxel.100nM..0.6nM -
    SUM159.DMSO,
  SUM159.JQ1.100nM.palbociclib.160nM_vs_DMSO = SUM159.JQ1.palbociclib.100nM..160nM -
    SUM159.DMSO,
