...
cm <- makeContrasts(
  ...
  KRAS_G12V.MS275_vs_KRAS_G12V.DMSO_6hr = G12V.MS275.6 - G12V.DMSO.6,
  KRAS_G12V.MS275_vs_KRAS_G12V.DMSO_24hr = G12V.MS275.24 - G12V.DMSO.24,
  KRAS_G12V.MS275_vs_KRAS_G12V.DMSO_72hr = G12V.MS275.72 - G12V.DMSO.72,
  KRAS_WT.MS275_vs_KRAS_WT.DMSO_1hr = WT.MS275.1 - WT.DMSO.1,
  KRAS_WT.MS275_vs_KRAS_WT.DMSO_6hr = WT.MS275.6 - WT.DMSO.6,
  KRAS_WT.MS275_vs_KRAS_WT.DMSO_24hr = WT.MS275.24 - WT.DMSO.24,
  KRAS_WT.MS275_vs_KRAS_WT.DMSO_72hr = WT.MS275.72 - WT.DMSO.72,
  levels = design
)
