...
cm <- makeContrasts(
  JURKAT.Etoposide.10uM.4hr_vs_Control.4hr = JURKAT.Etoposide.10uM.4hr -
    JURKAT.Control.4hr,
  NALM6.Etoposide.10uM.4hr_vs_Control.4hr = NALM6.Etoposide.10uM.4hr -
    NALM6.Control.4hr,
  RAMOS.Etoposide.10uM.4hr_vs_Control.4hr = RAMOS.Etoposide.10uM.4hr -
    RAMOS.Control.4hr,
  THP1.Etoposide.10uM.4hr_vs_Control.4hr = THP1.Etoposide.10uM.4hr -
    THP1.Control.4hr,
  U937.Etoposide.10uM.4hr_vs_Control.4hr = U937.Etoposide.10uM.4hr -
    U937.Control.4hr,
  X697.Etoposide.10uM.4hr_vs_Control.4hr = X697.Etoposide.10uM.4hr -
    X697.Control.4hr,
  levels = design
)
