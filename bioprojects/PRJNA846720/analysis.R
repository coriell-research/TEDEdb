...
cm <- makeContrasts(
  ...
  MIBG.Irinotecan.72hr_vs_MIBG.Irinotecan.baseline = MIBG.Irinotecan.72hr -
    MIBG.Irinotecan.baseline,
  MIBG.Vorinostat.72hr_vs_MIBG.vorinostat.baseline = MIBG.Vorinostat.72hr -
    MIBG.vorinostat.baseline,
  levels = design
)
