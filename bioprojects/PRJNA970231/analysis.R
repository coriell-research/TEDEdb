...
cm <- makeContrasts(
  MV4.11.Cytarabine.2uM.24h_vs_Incubation.24h = MV4.11.Cytarabine.2uM.24.h -
    MV4.11.Incubation.24.h,
  MV4.11.Chidamide.1uM.24h_vs_Incubation.24h = MV4.11.Chidamide.1uM.24.h -
    MV4.11.Incubation.24.h,
  MV4.11.Chidamide.cytarabine.1uM.2uM.24.h_vs_Incubation.24h = MV4.11.Chidamide.cytarabine.1uM.2uM.24.h -
    MV4.11.Incubation.24.h,
  levels = design
)
