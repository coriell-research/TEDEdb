...
cm <- makeContrasts(
  ...
  MOLT4.JQ1_vs_MOLT4.DMSO_6hr = MOLT4.JQ1.6 - MOLT4.DMSO.6,
  MOLT4.dBET6_vs_MOLT4.DMSO_2hr = MOLT4.dBET6.2 - MOLT4.DMSO.2,
  MOLT4.dBET6_vs_MOLT4.DMSO_6hr = MOLT4.dBET6.6 - MOLT4.DMSO.6,
  TALL_PDX.JQ1_vs_TALL_PDX.DMSO = T_ALL_PDX.JQ1.0 - T_ALL_PDX.DMSO.0,
  primary_T_cell.JQ1_vs_primary_T_cell.DMSO = primary_T_cell.JQ1.0 -
    primary_T_cell.DMSO.0,
  primary_T_cell.dBET6_vs_primary_T_cell.DMSO = primary_T_cell.dBET6.0 -
    primary_T_cell.DMSO.0,
  levels = design
)
